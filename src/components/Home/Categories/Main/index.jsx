...
const CategoriesMain = () => {
  ...
  const { data, isLoading, isFetching, error } = useQuery({ queryKey: ["users"], queryFn: fetchUsers });
  ...
  return (
    <div className="max-w-[1240px] px-4 m-auto flex justify-between items-start gap-6 mt-10">
            ...
            <MainMapping selectedCategory={selectedCategory} filteredPrice={filteredPrice}/>
        </div>
  );
};
